...
class InventoriesControllerTest < ActionController::TestCase
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post :create, inventory: { gamerating: @inventory.gamerating, gametitle: @inventory.gametitle, gametype: @inventory.gametype }
    end
  ...
  test "should update inventory" do
    patch :update, id: @inventory, inventory: { gamerating: @inventory.gamerating, gametitle: @inventory.gametitle, gametype: @inventory.gametype }
    assert_redirected_to inventory_path(assigns(:inventory))
  end
